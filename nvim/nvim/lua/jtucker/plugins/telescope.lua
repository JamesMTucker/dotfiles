return {
  ...
  config = function()
    ...
    keymap.set("n", "<leader>sh", "<cmd>Telescope help_tags<cr>", { desc = "Fuzzy find help tags" })
    keymap.set("n", "<leader>sw", "<cmd>Telescope grep_string<cr>", { desc = "Fuzzy find string in cwd" })
